        ...
        <div class="col-md-12" style="padding: 0 2px;">
            <div class="card">
                <div class="card-body table-container p-0">
                    <table id="suppliers-table" class="table table-striped table-bordered table-hover sticky" style="width:100%; height: calc(100vh - 155px);">
                        <thead>
                            <tr>
                                <th></th>
                ...
                let table = $('#suppliers-table').DataTable({
                    ...
                    columns: [
                        { data: 'edit', name: 'edit', orderable: false, class: 'text-center', searchable: false, render: function(data, type, row) {
                            ...
                            let link = `<a href="{{ route('dashboard.suppliers.edit', ':supplier') }}" class="btn btn-icon btn-icon text-primary edit_row"  data-id=":supplier"><i class="fa-solid fa-edit"></i></a>`.replace(':supplier', data);
                            return link ;
                            @else
                            return '';
                            @endcan
                        ...
                        { data: 'num_tax', name: 'num_tax' , orderable: false},
                        { data: 'email', name: 'email' , orderable: false},
                        { data: 'phone_number', name: 'phone_number' , orderable: false},
                        { data: 'address', name: 'address' , orderable: false},
                        { data: 'financial_category', name: 'financial_category' , orderable: false},
                    ...
                    footerCallback: function(row, data, start, end, display) {
                        ...
                        //     }, 0);
                        // $('#suppliers-table_filter').addClass('d-none');
                    }
                });
                $('#suppliers-table_filter').addClass('d-none');
